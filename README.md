...
## 4.1 Test Drive 
The test drive depicted on the map with a blue line below was carried out from Nuremberg to Munich on board the ICE train which reaches speeds of 300 km/h. The covered distance was around 170Km and the trip was around 1h30 of duration.

The GPS board update frequency for this test was programmed to around 3 seconds which resulted in around 1500 position points uploaded to the server. The coordinates uploaded to the server can be examined in this file.
